...
window.initSaniyeGame = function () {
    ...
    container.innerHTML = `
        ...
        <div id="saniye-result-view" class="game-container" style="display: none;">
            <h2 id="saniye-result-title">Tebrikler!</h2>
            <div class="score-box" id="saniye-final-score">100</div>
            <p id="saniye-score-details" style="color: var(--text-light);"></p>

            <div style="margin-top: 20px;">
                <h4>Gelen Sayılar:</h4>
                <div class="history-list" id="saniye-history-list"></div>
                <div style="font-size: 1.2rem; margin-top: 10px;">
                    Gerçek Toplam: <span id="saniye-true-sum" style="font-weight: bold;">0</span>
                </div>
            </div>
...
window.initKuvvetGame = function () {
    ...
    container.innerHTML = `
        ...
        <!-- Playing View -->
        <div id="kuvvet-playing-view" class="ka-container" style="display: none;">
        ...
        <div id="denklik-playing-view" class="da-container" style="display: none;">
            <div class="stats-bar">
                <div class="stat-box" style="background: #0f172a;">
                    <span class="stat-label" style="color: #64748b;">Skor</span>
                    <div class="stat-val" style="color: white;" id="denklik-score-display">0</div>
                </div>
                <div class="stat-box" id="denklik-streak-box">
                    <span class="stat-label">Seri</span>
                    <div class="stat-val" id="denklik-streak-display">x0</div>
                </div>
                <div class="stat-box" id="denklik-timer-box">
                    <span class="stat-label">Süre</span>
                    <div class="stat-val" id="denklik-timer-display">90s</div>
                </div>
            </div>
