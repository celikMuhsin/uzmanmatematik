...
window.initDenklikGame = function () {
    ...
    container.innerHTML = `
        ...
        <div id="denklik-playing-view" class="da-container" style="display: none;">
            <div class="stats-bar" style="display: flex; gap: 2rem; justify-content: center; margin-bottom: 2rem;">
                <div class="stat-box-bold" style="background: #0f172a; color: white;">
                    <span>SKOR</span> <span id="denklik-score-display" style="margin-left: 10px; color: #fbbf24;">0</span>
                </div>
                <div class="stat-box-bold" id="denklik-streak-box" style="background: #f1f5f9; color: #64748b;">
                    <span>SERİ</span> <span id="denklik-streak-display" style="margin-left: 10px;">x0</span>
                </div>
                <div class="stat-box-bold" id="denklik-timer-box" style="background: #4f46e5; color: white;">
                    <span>SÜRE</span> <span id="denklik-timer-display" style="margin-left: 10px;">90s</span>
                </div>
            </div>
