// carpanlara_ayirma.js Refactoring - Seviye 1      Bu dosya SoruMotoru nesnesini genişletir.    #region Seviye 1 Soru Tipleri

SoruMotoru.seviye1Tipleri = [
        ...
        uret: function (motor) {
            ...
            if (zar > 0.5) {
                ...
                if (sorulanAcilimMi) {
                    ...
                    const hamYanlislar = [
                        `(x - ${a})(x² - ${a}x + ${a * a})`, // İkinci parantez işareti yanlış
                        `(x + ${a})(x² - ${a}x + ${a * a})`, // İki küp toplamı formülü
                        `(x - ${a})³`,
                        `(x - ${a})(x² + ${2 * a}x + ${a * a})` // Tam kare
                    ];
                    return {
...
SoruMotoru.uretSeviye1 = function () {
