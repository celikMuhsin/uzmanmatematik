...
function renderGrid() {
    ...
    if (window.MathJax) {
        // Only typeset if new elements added ideally, but strictly typesetPromise is okay
        // To be safe/efficient, maybe only if we added nodes? 
        // For simplicity, just typeset. MathJax 3 is reasonably smart.
