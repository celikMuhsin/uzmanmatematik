...
window.showPage = (pageIds) => {
    // Hide all
    const pages = ['home-page', 'news-page', 'news-detail', 'games-page', 'lessons-page', 'resources-page', 'columnist-detail', 'quiz-page', 'all-columnists-page', 'contact-page', 'edebiyat-game-page', 'saniye-game-page', 'kuvvet-game-page', 'denklik-game-page'];
    pages.forEach(id => {
    ...
    if (gamesMenu) {
        if (gamePages.includes(pageIds)) {
            gamesMenu.style.display = 'block'; // Ensure it's open for games
        } else {
