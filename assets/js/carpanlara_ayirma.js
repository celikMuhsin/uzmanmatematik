...
const SoruMotoru = {
    ...
    // --- SORU TİPİ: Seviye 1 (Modüler Yapı) ---


    seviye1Filtre: [],  // Örnek: ['car1_1', 'car1_2'] sadece bu tipleri sorar. Boş bırakılırsa veya null olursa tüm tiplerden sorar.
    ...
    seviye1Tipleri: [
        {
            kod: "car1_1",
            aciklama: "Ortak Çarpan Parantezi (ax ± b)",
            uret: function (motor) {
        ...
        {
            kod: "car1_1.2",
            aciklama: "Ortak Çarpan - İleri (k(ax ± b))",
            uret: function (motor) {
                let k, a, b;
        ...
        {
            kod: "car1_2",
            aciklama: "İki Kare Farkı (x² - n²)",
            uret: function (motor) {
                const n = motor.random(1, 16);
                const kare = n * n;
        ...
        {
            kod: "car1_3",
            aciklama: "Tam Kare Özdeşliği (x ± n)²",
            uret: function (motor) {
        ...
        {
            kod: "car1_4",
            aciklama: "Üç Terimli İfadeler (x² + bx + c)",
            uret: function (motor) {
                // x^2 + bx + c -> (x+m)(x+n)
                let m, n;
                do {
                ...
                // 2. Akıllı Çeldirici (Smart Distractor)
                const delta = b * b + 4 * c;
                if (delta >= 0) {
    ...
    // --- SORU TİPİ: Seviye 2 (Modüler Yapı) ---
    seviye2Filtre: [],
    sonSeviye2Tipi: null,
    ...
    // --- SORU TİPİ: Seviye 3 (Kesirli ve Sadeleştirmeli İfadeler) ---
    seviye3Filtre: [],
    sonSeviye3Tipi: null,
    ...
    uretSeviye5: function () {
        return {
            metin: "Seviye 5 sorularının tümü Seviye 2'ye taşınmıştır.",
            siklar: [],
            ipucu: "Lütfen Seviye 2'yi veya diğer seviyeleri seçiniz."
        };
    },
